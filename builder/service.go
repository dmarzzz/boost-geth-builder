...
func Register(stack *node.Node, backend *eth.Ethereum, cfg *BuilderConfig) error {
	...
	log.Info("NewBoostService", "types.DomainTypeAppBuilder", boostTypes.DomainTypeAppBuilder, "genesisForkVersionHex", genesisForkVersionBytes, "genesisValidatorsRootHex", boostTypes.Root{}.String())
